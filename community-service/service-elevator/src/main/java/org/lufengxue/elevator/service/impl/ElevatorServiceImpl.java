...
//        }
//        //获取当栋大楼的楼层号,判断楼层号的范围
//        List<Floor> floors = floorService.getFindFloor(buildingName);
...
//        List<Elevator> elevatorList = findElevator(buildingName);
//
////        // 转成json 在推送给用户
...
//        Set<org.lufengxue.pojo.elevator.elevatorPO.Elevator> elevators = building.getElevators();
//        for (org.lufengxue.pojo.elevator.elevatorPO.Elevator ele : elevators) {
...
//     * @param id           电梯id
//     * @return 返回当前到达目的地的电梯数据
//     */
//    @Override
//    public Elevator runElevator(Set<Integer> floorButtons, Integer id) {
//        //非空判断
//        if (CollectionUtils.isEmpty(floorButtons) || id == null || id <= 0) {
//            throw new RuntimeException("floorButtons参数不可为空");
//        }
//        //根据电梯id 查询电梯列表获取对应的属性,
//        org.lufengxue.pojo.elevator.elevatorPO.Elevator elevator = elevatorConfig.queryElevatorDataById(id);
...
//        //根据用户电梯id 查询出对应的大楼楼层号 用来遍历电梯
////        List<org.lufengxue.pojo.elevator.elevatorPO.Floor> floorList = elevatorConfig.getFloorNumberById(id);
...
//        elevator.setId(id);
//        elevator.setInFloor(inFloor);
//        elevator.setSports(sports);
...
//     * @param floorList 用户所在大楼的 所有楼层号
//     */
//    private Integer getRunElevator(List<Integer> floors, Integer sports, Integer inFloor, List<org.lufengxue.pojo.elevator.elevatorPO.Floor> floorList) {
//        if (CollectionUtils.isEmpty(floors)) {
...
//            //获取目标楼层集合中最后一个参数值
//            for (org.lufengxue.pojo.elevator.elevatorPO.Floor floor : floorList) {
...
//        Set<org.lufengxue.pojo.elevator.elevatorPO.Elevator> elevators = building.getElevators();
//        for (org.lufengxue.pojo.elevator.elevatorPO.Elevator ele : elevators) {
//                if (ele.getId().equals(elevator.getId())) {
...
//            }
//        //  设置返回前端的数据
//        elevator.setInFloor(fl);
//        elevator.setSports(2);
//        return elevator;
//    }
//
//    /**
